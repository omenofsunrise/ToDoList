...
const EditGoalModal = ({ open, onClose, editingGoal, setEditingGoal, updateGoalMutation }) => {
  ...
  const validateFields = () => {
    const newErrors = {};
    if (!editingGoal.nameGoal?.trim()) {
      newErrors.nameGoal = 'Название цели обязательно';
    }
    if (!editingGoal.abNameGoal?.trim()) {
      newErrors.abNameGoal = 'Аббревиатура цели обязательна';
    } else if (editingGoal.abNameGoal.length > 5) {
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <TextField
          ...
          fullWidth
          margin="normal"
          value={editingGoal.nameGoal || ''}
          onChange={(e) =>
            setEditingGoal({ ...editingGoal, nameGoal: e.target.value })
          }
        ...
        <TextField
          ...
          fullWidth
          margin="normal"
          value={editingGoal.abNameGoal || ''}
          onChange={(e) =>
            setEditingGoal({ ...editingGoal, abNameGoal: e.target.value })
          }
